...
public class Split_XML_Convert_to_CSV_Menu_To_CSV_Compute_0001_Test {

	/*
	 * Split_XML_Convert_to_CSV_Menu_To_CSV_Compute_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.1.0 on Nov 18, 2021 4:18:54 PM
	 */
	...
	@Test
	public void Split_XML_Convert_to_CSV_Menu_To_CSV_Compute_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("Split_XML_Convert_to_CSV")
				.messageFlow("Menu_To_CSV").node("Compute");
		...
		try {
			String messageAssemblyPath = "/Menu_To_CSV_Compute_0001_7330f222-2d4a-4eb8-a119-b478a290da2d_input_data.mxml";
